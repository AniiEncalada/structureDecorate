...
public class Person implements Task{
    ...
    public void tarea()
    {
       System.out.println("I am a person and I do general tasks");
    }
    
    public void task()
    {
        System.out.println("SOY UNA PERSONA --> " + this.getClass().getCanonicalName().toUpperCase() + 
            " EJECUTO TAREAS GENERALES");
    }
